...
def tile(data: Expr, repeats: Union[PrimExprLike, Tuple[PrimExprLike], List[PrimExprLike]]) -> Expr:
    ...
    repeats : Union[PrimExprLike, Tuple[PrimExprLike], List[PrimExprLike]]
