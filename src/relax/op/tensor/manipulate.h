 ...
 */
Expr permute_dims(Expr data, Optional<Array<Integer>> axes);
 ...
 */
Expr expand_dims(Expr data, Array<Integer> axis);
 ...
 * \param data An Expr in Tuple type, containing the tensors to be concatenated.
