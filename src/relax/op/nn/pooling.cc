...
TVM_REGISTER_GLOBAL("relax.op.nn.max_pool2d").set_body_typed(MaxPool2D);
...
TVM_REGISTER_GLOBAL("relax.op.nn.adaptive_avg_pool2d").set_body_typed(AdaptiveAvgPool2D);
