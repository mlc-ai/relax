...
def test_op_correctness():
    ...
    assert relax.op.grad.conv2d_backward_weight(g, x, y).op == Op.get(
        "relax.grad.conv2d_backward_weight"
    )
...
def test_conv2d_backward_infer_struct_info():
    ...
    _check_inference(bb, relax.op.grad.conv2d_backward_weight(g, x, y), y.struct_info)
