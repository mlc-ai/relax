...
def test_tile():
    ...
    class Expected:
        ...
        def main(
            x: R.Tensor((3, 2, 3), dtype="float32")
        ) -> R.Tensor((2, 3, 4, 9), dtype="float32"):
        ...
        def tile(
            rxplaceholder: T.Buffer((T.int64(3), T.int64(2), T.int64(3)), "float32"),
            T_tile: T.Buffer((T.int64(2), T.int64(3), T.int64(4), T.int64(9)), "float32"),
        ):
            T.func_attr({"tir.noalias": True})
            # with T.block("root"):
            for ax0, ax1, ax2, ax3 in T.grid(
                T.int64(2), T.int64(3), T.int64(4), T.int64(9)
            ):
                with T.block("T_tile"):
                    v_ax0, v_ax1, v_ax2, v_ax3 = T.axis.remap("SSSS", [ax0, ax1, ax2, ax3])
                    T.reads(
                        rxplaceholder[
                            v_ax1 % T.int64(3), v_ax2 % T.int64(2), v_ax3 % T.int64(3)
                        ]
                    )
                    T.writes(T_tile[v_ax0, v_ax1, v_ax2, v_ax3])
                    T_tile[v_ax0, v_ax1, v_ax2, v_ax3] = rxplaceholder[
                        v_ax1 % T.int64(3), v_ax2 % T.int64(2), v_ax3 % T.int64(3)
                    ]
    # fmt: on
