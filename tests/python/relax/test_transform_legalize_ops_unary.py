...
def test_abs():
    ...
    class Expected:
        ...
        def main(x: R.Tensor((2, 3), dtype="float32")) -> R.Tensor((2, 3), dtype="float32"):
            gv = R.call_tir(abs, (x,), (2, 3), dtype="float32")
            return gv
...
def test_abs_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), dtype="float32")) -> R.Tensor(("m", "n"), dtype="float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(abs, (x,), (m, n), dtype="float32")
            return gv
...
def test_cos_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), "float32")) -> R.Tensor(("m", "n"), "float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(cos, (x,), (m, n), dtype="float32")
            return gv
...
def test_log_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), "float32")) -> R.Tensor(("m", "n"), "float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(log, (x,), (m, n), dtype="float32")
            return gv
...
def test_negative_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), "float32")) -> R.Tensor(("m", "n"), "float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(negative, (x,), (m, n), dtype="float32")
            return gv
...
def test_sigmoid_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), "float32")) -> R.Tensor(("m", "n"), "float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(sigmoid, (x,), (m, n), dtype="float32")
            return gv
...
def test_sin_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), "float32")) -> R.Tensor(("m", "n"), "float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(sin, (x,), (m, n), dtype="float32")
            return gv
...
def test_sqrt_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), "float32")) -> R.Tensor(("m", "n"), "float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(sqrt, (x,), (m, n), dtype="float32")
            return gv
...
def test_tanh_symbolic():
    ...
    class Expected:
        ...
        def main(x: R.Tensor(("m", "n"), "float32")) -> R.Tensor(("m", "n"), "float32"):
            m = T.var("int64")
            n = T.var("int64")
            gv = R.call_tir(tanh, (x,), (m, n), dtype="float32")
            return gv
