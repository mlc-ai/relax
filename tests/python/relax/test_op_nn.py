...
def test_batch_norm_infer_struct_info_symbolic():
    bb = relax.BlockBuilder()
    n = tir.Var("n", "int64")
    c0 = tir.Var("c", "int64")
    c1 = tir.Var("c", "int64")
...
def test_layer_norm_infer_struct_info_symbolic():
    bb = relax.BlockBuilder()
    n = tir.Var("n", "int64")
    a = tir.Var("a", "int64")
    b = tir.Var("b", "int64")
...
def test_matmul_infer_struct_info_symbolic():
    bb = relax.BlockBuilder()
    m = tir.Var("m", "int64")
    n = tir.Var("n", "int64")
    k0 = tir.Var("k0", "int64")
...
def test_dropout_infer_struct_info_symbolic():
    bb = relax.BlockBuilder()
    m = tir.Var("m", "int64")
    n = tir.Var("n", "int64")
...
def test_cross_entropy_infer_struct_info_symbolic():
    bb = relax.BlockBuilder()
    m0 = tir.Var("m", "int64")
    m1 = tir.Var("m", "int64")
    n = tir.Var("n", "int64")
